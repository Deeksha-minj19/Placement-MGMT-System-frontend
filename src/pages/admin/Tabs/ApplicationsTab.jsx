            ...
            <div className="p-6 overflow-y-auto space-y-6">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                {selectedApp.resume_url && (
                  <a href={`http://localhost:5000${selectedApp.resume_url}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-lg transition-colors">
